...
首页产品分为两类，不使用 Tab、轮播或其他会隐藏内容的交互：

- **个人产品**：面向直接体验和未来购买，始终位于首屏；CTA 使用“立即体验 / 立即探索”等行动语言。
- **银行专业作品**：面向专业能力评估、项目合作和职业机会，紧接个人产品区出现；顶部导航提供“银行作品”直达入口，CTA 使用“查看演示 / 查看详细介绍 / 项目合作”。

银行专业作品区当前包含房贷止赎数据血缘与 ALM 经营分析报表。ALM 在首页生成常显详情区，展示真实 Dashboard 截图、核心能力、用户角色和静态演示边界；完整模块范围使用原生 `<details>` 折叠，避免形成大段功能墙。

### 3.2 个人产品与银行作品衔接

不再单设“找到适合你的个人产品”场景区。个人产品的用途、适合人群与直接行动由首屏产品卡一次说明，避免紧邻区块重复介绍同一批产品。

个人产品之后直接进入 **银行金融与数据产品作品**，用明确标题和简介帮助招聘方、银行客户与合作方快速识别专业方向；FCL、ALM 与 FTP 保持全部常显，不使用 Tab 或轮播隐藏作品。
...
产品列表由 Astro Markdown Content Collection 驱动。每款产品使用稳定 ID，并在一份产品档案中声明类别、排序、发布状态、链接、视觉、三语卡片文案及可选首页详情。首页按 `personal` / `professional` 自动分组；缺少任一必需语言、分类或链接时构建失败。未来新增产品应新增产品档案与封面图，不复制首页卡片结构。
...
| 日期 | 变更内容 |
|------|----------|
| 2026-08-04 | 删除重复的个人产品场景区，并让银行金融与数据产品作品紧接首屏且支持导航直达；why：减少重复介绍，同时帮助招聘方快速发现银行专业成果 |
| 2026-07-29 | 将首页产品体系拆分为“个人产品”与“银行专业作品”，并确定 Markdown 产品档案、自动分组和可选首页详情机制；why：服务购买型访客与专业能力评估型访客，同时降低后续新增产品的维护成本 |
